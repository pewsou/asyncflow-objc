...
#import "ASFKBase.h"
@interface ASFKFoldPar : ASFKCombination
-(NSArray*) runLeft:(ASFKExecutableProcedure)proc withValue:(id)value onArray:(NSArray*)array withSummary:(ASFKExecutableProcedureSummary)summary;
-(NSArray*) runRight:(ASFKExecutableProcedure)proc withValue:(id)value onArray:(NSArray*)array withSummary:(ASFKExecutableProcedureSummary)summary;
